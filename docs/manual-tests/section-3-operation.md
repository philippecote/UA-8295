...
```ua8295-test
{
  ...
  "title": "Offline encryption and decryption round-trip five-character groups without a printer",
  "status": "pass",
  "steps": [
    { "pressShifted": "CONF" },
    { "press": "SHORT_TERM" },
    ...
    { "press": "SHORT_TERM" },
    { "press": "0" },
    { "pressShifted": "ENCR", "expectDisplay": "PRINTER OUTPUT (Y/N)?" },
    { "press": "N", "settleSlices": 1200 },
    { "press": "SCROLL_LEFT" },
    { "press": "SCROLL_LEFT" },
    { "pressShifted": "DEL" },
    { "press": "L" },
    ...
    { "press": "K" },
    { "press": "A" },
    { "press": "ENCR", "expectDisplay": "PRINTER OUTPUT (Y/N)?" },
    { "press": "N", "settleSlices": 1200 }
  ],
  "expectDisplay": "HELLO."
}
